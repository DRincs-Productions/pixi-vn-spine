import type { ContainerMemory } from "@drincs/pixi-vn";
...
interface MemoryCore extends Omit<
    ...
    | "skeletonData"
> {}
export default interface SpineMemory extends MemoryCore, Omit<ContainerMemory, "scale">, Omit<SpineOptions, "scale"> {
